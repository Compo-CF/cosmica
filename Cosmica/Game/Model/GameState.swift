...
struct GameState: Codable {
    ...
    /// Per-generator auto-buy opt-in. Key is generator.id, value is whether the
    /// player has toggled auto-buy ON for that generator. Missing key = off.
    /// The tier gate (Autonomy branch unlock) is checked separately in
